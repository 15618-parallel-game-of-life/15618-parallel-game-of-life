...
for j in range(num_game):
  ...
  if (random.randint(0, 1) == 0):
    ...
    print("Game: " + str(j) + "; rand Score: " + str(left_score) +
          "; model Score: " + str(right_score))
    ...
    left_score, right_score = env.simulate()
    print("Game: " + str(j) + "; model Score: " + str(left_score) +
          "; rand Score: " + str(right_score))
...
print("Num of Game: {}; Win: {}; Draw: {}; Win rate: {}; Draw rate: {}".format(
    num_game, win, draw, win/num_game, draw/num_game))
